# Vendor Risk Assessment (Article 28): Slack Example

An assessment of Slack as a data processor, based on their published Data Processing Addendum, sub-processor list, transfer mechanisms, and security documentation, checked against GDPR Article 28 requirements. Uses Slack's own public documentation, no personal data involved.
...
Full assessment: [01-slack-assessment.md](01-slack-assessment.md)
